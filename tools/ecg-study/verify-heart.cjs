...
(async()=>{
 ...
 try{
  ...
  assert((await page.locator('.ecg-3d-label[data-structure="svc"]').textContent()).includes('DEOXYGENATED IN'));
  assert((await page.locator('.ecg-3d-label[data-structure="vein"]').textContent()).includes('OXYGENATED IN'));
  assert((await page.locator('.ecg-3d-label[data-structure="pa"]').textContent()).includes('TO LUNGS'));
  assert((await page.locator('.ecg-3d-label[data-structure="aorta"]').textContent()).includes('TO BODY'));
